...
class PublicIngredientApitTests(TestCase):
	...
	def test_login_required(self):
		...
		res = self.client.get(INGREDIENTS_URL) #Tries to make a request. Will get an unauthorized error

		self.assertEqual(res.status_code, status.HTTP_401_UNAUTHORIZED)


class PrivateIngredientsApiTests(TestCase):
	#Test the Private Inigredients API
	...
	def test_create_ingredient_invalid(self):
		#test creating an invalid field
		payload = {'name':''}
