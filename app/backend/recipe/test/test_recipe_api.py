...
from backend.core.models import Recipe, Tag, Ingredient
from backend.recipe.serializers import RecipeSerializer, RecipeDetailSerializer
...
class RecipeImageUploadTests(TestCase):
	...
	def test_filter_recipes_tags(self):
		#test returning recipes by searching their tags
		...
		recipe3 = sample_recipe(user=self.user, title="Fish Grits")
